          ...
          <form onSubmit={handleSubmit} className="flex-1 ml-40 mr-40">
            <div className="grid grid-cols-2 gap-5 mt-5 " style={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
              <FormControl style={{width:"50%"}}>
                <label style={{marginBottom:"0.3rem"}}>First Name*</label>
                <TextField
                  size="small"
                  type="text"
                  name="firstName"
              ...
              <FormControl style={{width:"50%"}}>
                <label style={{marginBottom:"0.3rem"}}>Last Name*</label>
                <TextField
                  size="small"
                  type="text"
                  name="lastName"
              ...
              <FormControl style={{width:"50%"}}>
                <label style={{marginBottom:"0.3rem"}}>Email Address*</label>
                <TextField
                  size="small"
                  type="email"
                  name="email"
              ...
              <FormControl style={{width:"50%"}}>
                <label style={{marginBottom:"0.3rem"}}>Password*</label>
                <TextField
                  type="password"
                  name="newPassword"
                  size="small"
              ...
              <FormControl style={{width:"50%"}}>
                <label style={{marginBottom:"0.3rem"}}>Confirm Password*</label>
                <TextField
            ...
            <div className="mt-16" style={{display:"flex", justifyContent:"center", marginTop:"1rem"}}>
              <Button
                variant="contained"
                type="submit"
                sx={{
